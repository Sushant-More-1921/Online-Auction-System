            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  ...
                  >
                    ...
                    <option value="Meezan Bank">ICICI Bank</option>
                    <option value="UBL">SBI</option>
                    <option value="HBL">Bank of Baroda</option>
                    <option value="Allied Bank">Bank of India</option>
                  </select>
                  <input
                    type="text"
              ...
              <div>
                <label className="text-[16px] text-stone-600 font-semibold">
                  Google Pay OR PhonePe Details
                </label>
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  <input
                    type="number"
                    value={easypaisaAccountNumber}
                    placeholder="Google Pay or PhonePe Number"
                  ...
                  <input
                    type="email"
                    value={paypalEmail}
                    placeholder="Google Pay or PhonePe Email"
